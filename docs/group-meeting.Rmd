...
Then, we could probably computed instead 
...
E.g. if using UK Biobank imputed data to compute correlations.
...
You need to recompute them, instead of using the one reported.
